...
import com.example.saquib.dulhaniyaacom.BuildConfig;
...
public class TakeImage extends Activity {
    ...
    private final String capture_dir = Environment.getExternalStorageDirectory() + "/Dulhaniyaa/Images/";
    Activity activity;
    ...
    public class MarshMallowPermission {
        ...
        public boolean requestPermissionForExternalCameraStorage() {
            if (ActivityCompat.shouldShowRequestPermissionRationale(activity, android.Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                ...
                ActivityCompat.requestPermissions(activity, new String[]{android.Manifest.permission.WRITE_EXTERNAL_STORAGE}, CAMERA_EXTERNAL_STORAGE_PERMISSION_REQUEST_CODE);
            }
            return true;
        }

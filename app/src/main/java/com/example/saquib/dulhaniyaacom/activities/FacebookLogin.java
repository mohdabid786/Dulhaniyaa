...
//        AppEventsLogger.activateApp(this);
    ...
    public static String printKeyHash(Activity context) {
        ...
        String keyHash = null;
        try {
            //getting application's package name, as defined in manifest
            String packageName = context.getApplicationContext().getPackageName();
            Log.w("Package Name: ", context.getApplicationContext().getPackageName());
            ...
            for (Signature signature : packageInfo.signatures) {
                ...
                Log.w("Dynamic KeyHash: ", keyHash);
            }
        } catch (PackageManager.NameNotFoundException | NoSuchAlgorithmException e) {
            Log.e("KEY HASH ERROR!", e.toString());
            e.printStackTrace();
    ...
    private void fbSignIn() {
      /*  try {
            PackageInfo info = getPackageManager().getPackageInfo("com.sats.quickeats.activities", PackageManager.GET_SIGNATURES);
                    ...
                    public void onCompleted(JSONObject object, GraphResponse response) {
                        try {
                            ...
                            if (object != null) {
                                ...
                                if (email != null)
                                    SharedPreferenceWriter.getInstance(FacebookLogin.this).writeStringValue(SharedPreferenceKey.Email, email);

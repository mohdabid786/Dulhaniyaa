...
import com.example.saquib.dulhaniyaacom.fragment.MyFavourite;
...
public class MYFavAdap extends RecyclerView.Adapter<MYFavAdap.MyFavAdap> {
    ...
    public MYFavAdap(FragmentActivity activity, List<MyFavouriteResponse> myFavouriteResponseList, MyFavourite fragment) {
    }

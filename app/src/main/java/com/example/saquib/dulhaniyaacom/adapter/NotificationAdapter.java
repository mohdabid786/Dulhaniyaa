...
public class NotificationAdapter extends RecyclerView.Adapter<NotificationAdapter.MyViewHolder>{
    ...
    public NotificationAdapter(Context context, List<NotificationResponse> noti) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        aQuery.id(holder.iv_notif_user).image(noti.get(position).getImage_url(), false, false, 0, R.drawable.webcover1);
